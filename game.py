...
class SnakeGame:
    ...
    def do_training(self):
        ...
        for game in range(1, self.args.NUM_TRAIN_ITER + 1):
            ...
            # Perform a single episode of the game
            ...
            # Append the points achieved in the current episode to the points_results list
    ...
    def do_testing(self):
        ...
        for game in range(1, self.args.NUM_TEST_ITER + 1):
            ...
            # Print the final score for this game
            print(f"Game {game} score: {points}")

            # Add the points to the results list
